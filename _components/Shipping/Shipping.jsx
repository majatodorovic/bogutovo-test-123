    ...
    return (
        <>
            <div className='relative'>
                <button className='bg-boa-dark-blue p-[0.4rem] sm:mr-[4rem] max-sm:mr-[0.6rem] ml-[1re] rounded-[50%] mt-[0.4rem] hover:translate-y-0.5 transition-all ease cursor-pointer text-white min-w-[2.2rem] absolute md:top-4 md:left-4' onClick={handleGoBack}>
                    <Image
                    src={back}
                    alt="back button"
            ...
            <div className='bg-[#f8f8f8] rounded-lg p-[1.4rem] md:w-[70%] mb-[3rem]'>
                ...
                <div>
                    ...
                    <div className="mt-4">
                        <button onClick={() => setDisabled(false)} className="bg-boa-dark-blue text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80 mr-4">Izmena informacija</button>
