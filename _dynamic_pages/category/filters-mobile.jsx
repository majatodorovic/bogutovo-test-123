  ...
  return (
    <>
      <div className="h-full flex flex-col px-[0.7rem]">
        ...
        >
          <p className="text-[#171717] self-center mx-auto font-normal text-center text-[1rem]">
            Filteri
          </p>
          <i
        ...
        <div className="flex w-[95%] mx-auto flex-col border-b border-b-[#f5f5f5] py-[23px] overflow-hidden">
          ...
          >
            <p className="text-[1rem] font-normal">Sortiranje</p>
          ...
          return (
            <div key={index}>
              ...
              >
                ...
                <div>
                  <p className={`text-[#171717] text-[1.2rem] font-normal `}>
                    {isOpen ? `-` : `+`}
                  </p>
                </div>
              </div>
        ...
        >
          ...
          >
            <p className={`text-[1.2rem] font-normal text-center py-3`}>
              Resetuj
            </p>
          </button>
          <button
