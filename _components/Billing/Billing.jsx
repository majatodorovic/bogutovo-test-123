  ...
  return (
    <>
      <div className="relative">
        <button
          className="bg-boa-dark-blue p-[0.4rem] sm:mr-[4rem] max-sm:mr-[0.6rem] ml-[1re] rounded-[50%] mt-[0.5rem] hover:translate-y-0.5 transition-all ease cursor-pointer text-white min-w-[2.2rem] absolute md:top-4 md:left-4"
      ...
      <div>
        ...
        <div>
          ...
          <div className="termsAgree flex items-center md:w-[70%]">
            ...
            />
            <label htmlFor="set_default" className="max-md:text-xs">
        ...
        <div>
          ...
          <div className="mt-4">
            <button
              ...
              className="bg-boa-dark-blue text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80 mr-4"
            >
              Izmena informacija
            </button>
            <button
