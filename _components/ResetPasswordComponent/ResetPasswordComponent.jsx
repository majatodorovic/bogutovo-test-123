...
import classes from "@/_components/Registration/Registration.module.css";
...
const ResetPasswordComponent = ({ token }) => {
  ...
  return (
    <div className="mt-[0rem] lg:mt-[9rem] mb-[6rem] mx-auto w-[90%] flex">
      <div>
        <Link href="/nalog">
          <div className="bg-boa-dark-blue p-[0.4rem] mr-[4rem] ml-[1re] rounded-[50%] mt-[0.4rem] hover:translate-y-0.5 transition-all ease cursor-pointer text-white">
            <Image
              src={back}
              alt="back button"
