        ...
        <div>
          ...
          <div className="mt-4 max-sm:flex max-sm:flex-col gap-4 pt-[2rem]">
            <button
              ...
              className="bg-boa-dark-blue rounded-lg text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80 md:mr-4 max-sm:px-[1rem] min-w-[13rem] transition-all ease"
            >
              Izmena informacija
            </button>
            <button
              onClick={changeInputHandler}
              className="bg-boa-dark-blue rounded-lg text-white py-[0.8rem] px-[2rem] max-sm:px-[1rem] hover:bg-opacity-80 min-w-[13rem] transition-all ease"
            >
              Sačuvaj izmene
            </button>
          </div>
