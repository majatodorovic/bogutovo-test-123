        ...
        <div className={`col-span-full mt-5`}>
          <div className={`${showOptions ? "mb-5" : ""}`}>
            <button
              disabled={isPending}
              type={`submit`}
              className={`w-full bg-boa-red hover:bg-boa-red/80 text-white font-medium py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-boa-red sm:text-base shadow disabled:opacity-50 ${buttonClassName}`}
            >
              {isPending ? (
                <div
