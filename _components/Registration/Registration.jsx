      ...
      <div className="h-[100%] flex flex-col items-center">
        <div className="loginHolder lg:w-[74%] max-lg:w-[90%] max-sm:w-[94%]">
          ...
          <button
            ...
            className="bg-boa-dark-blue mt-8 text-white py-[0.7rem] px-[1.3rem] text-sm hover:bg-opacity-70 lg:mr-[2rem] max-lg:ml-[2rem] max-md:whitespace-nowrap"
          >
            NAPRAVI NALOG
          </button>
          ...
          <div
            ...
            className={
              reg
                ? `z-[20000] scale-100 transition-all duration-500 fixed max-md:mx-auto max-md:overflow-y-scroll top-0 left-0 w-screen h-screen flex items-center justify-center popup text-black max-sm:pt-[20rem]`
                : `z-[20000] fixed max-md:mx-auto max-md:overflow-y-scroll scale-0 transition-all duration-500  top-0 left-0 w-screen h-screen flex items-center justify-center popup text-black max-sm:pt-[20rem]`
            }
          >
            <div
              className={`
            ...
            >
              ...
              <p className="mb-[1.4rem] mt-[0.4rem]  text-[#4b4b4b]">
                Vaši podaci
              </p>
                ...
                <form className="mt-4 grid sm:grid-cols-2 gap-x-10 pb-4 max-xl:text-base ">
                  ...
                  <div className=" flex sm:gap-3 sm:py-3 relative flex-col max-sm:mt-[2rem]">
                    <div className="termsAgree flex items-center">
                      ...
                      >
                        Slažem se sa Bogutovo politikom privatnosti i čuvanjem
                        podataka.
                      </label>
                    </div>
                  ...
                  <div className="mt-2 flex gap-3 py-3 relative flex flex-col">
                    <div className="termsAgree flex items-center">
                      <input
                        ...
                        className="focus:ring-0 focus:border-none focus:outline-none text-[#191919] bg-boa-dark-blue mr-[0.4rem]"
                      />
                      <label
                        htmlFor="accept_terms"
                    ...
                    <div className="nlAgree flex items-center ">
                      <input
                        ...
                        className="focus:ring-0 focus:border-none focus:outline-none text-[#191919] bg-boa-dark-blue mr-[0.4rem] rounded-sm rounded-sm"
                      />
                      <label
                        htmlFor="accept_newsletter"
              ...
              <button
                ...
                className="bg-boa-dark-blue text-white py-[0.7rem] px-[1.3rem] text-sm hover:bg-opacity-70 w-fit ml-auto"
              >
                {loading ? (
